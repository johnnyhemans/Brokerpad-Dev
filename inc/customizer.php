<?php
  function wpb_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('showcase_heading', array(
      'default'   => _x('Brokerpad', 'wpbootstrap'),
      'type'      => 'theme_mod'
    ));
    ...
    $wp_customize->add_setting('showcase_text', array(
      'default'   => _x('Broking Made Simple', 'wpbootstrap'),
      'type'      => 'theme_mod'
    ));
    ...
    $wp_customize->add_setting('btn_text', array(
      'default'   => _x('Try Brokerpad For Free', 'wpbootstrap'),
      'type'      => 'theme_mod'
    ));
  ...
  $wp_customize->add_setting('showcase_small_text', array(
    'default'   => _x('No Credit Card Required', 'wpbootstrap'),
    'type'      => 'theme_mod'
  ));

  $wp_customize->add_control('showcase_small_text', array(
    'label'   => __('Alt Description', 'wpbootstrap'),
    'section' => 'showcase',
    'priority' => 6
  ));
}
